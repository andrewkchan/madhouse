function DualUziManager(player) {
  ...
  player._weapon2 = game.add.weapon(0, "particle");
  this.player._weapon2.bulletClass = RevolverBullet;
  this.player._weapon2.createBullets(-1);
  this.player._weapon2.bulletKillType = Phaser.Weapon.KILL_WORLD_BOUNDS;
  this.player._weapon2.bulletSpeed = 250;
  this.player._weapon2.fireRate = 120; // ms between each shot in autofire mode
  this.player._weapon2.bulletAngleVariance = 10; // degrees of shot spread
}
...
DualUziManager.prototype.initForegroundAnims = function() {
  ...
  player._weaponHandR._recoilTween =
    game.add.tween(player._weaponHandR).to({ x: 4, rotation: '-0.1' }, 20, Phaser.Easing.Linear.None);
  player._weaponHandR._recoilTween.chain(
    game.add.tween(player._weaponHandR).to({ x: 7, rotation: '+0.1' }, 50, Phaser.Easing.Linear.None)
  );
  ...
  player._weaponHandR2._recoilTween =
    game.add.tween(player._weaponHandR2).to({ x: -5, rotation: '-0.1' }, 20, Phaser.Easing.Linear.None);
  player._weaponHandR2._recoilTween.chain(
    game.add.tween(player._weaponHandR2).to({ x: -2, rotation: '+0.1' }, 50, Phaser.Easing.Linear.None)
  );
  ...
  player._weaponHandL._recoilTween =
    game.add.tween(player._weaponHandL).to({ x: -3, rotation: '+0.1' }, 20, Phaser.Easing.Linear.None);
  player._weaponHandL._recoilTween.chain(
    game.add.tween(player._weaponHandL).to({ x: -6, rotation: '-0.1' }, 50, Phaser.Easing.Linear.None)
  );
  ...
  player._weaponHandL2._recoilTween =
    game.add.tween(player._weaponHandL2).to({ x: 5, rotation: '+0.1' }, 20, Phaser.Easing.Linear.None);
  player._weaponHandL2._recoilTween.chain(
    game.add.tween(player._weaponHandL2).to({ x: 2, rotation: '-0.1' }, 50, Phaser.Easing.Linear.None)
  );
  ...
  player._weaponHandD._recoilTween =
    game.add.tween(player._weaponHandD).to({ y: 5, rotation: '-0.1' }, 20, Phaser.Easing.Linear.None);
  player._weaponHandD._recoilTween.chain(
    game.add.tween(player._weaponHandD).to({ y: 9, rotation: '+0.1' }, 50, Phaser.Easing.Linear.None)
  );
  ...
  player._weaponHandD2._recoilTween =
    game.add.tween(player._weaponHandD2).to({ y: 5, rotation: '-0.1' }, 20, Phaser.Easing.Linear.None);
  player._weaponHandD._recoilTween.chain(
    game.add.tween(player._weaponHandD2).to({ y: 9, rotation: '+0.1' }, 50, Phaser.Easing.Linear.None)
  );
...
DualUziManager.prototype.update = function(angle, isVisible = true) {
  ...
  if (isVisible) {
    if (MathUtil.isDown(angle)) {
      ...
      player._weapon2.trackSprite(player._weaponHandD2, 7, -3, true);
    } else if (MathUtil.isRight(angle)) {
      ...
      player._weapon2.trackSprite(player._weaponHandR2, 7, -3, true);
    } else if (MathUtil.isUp(angle)) {
      ...
      player._weapon2.trackSprite(player._weaponHandU2, 7, -3, true);
    } else {
      ...
      player._weapon2.trackSprite(player._weaponHandL2, 7, 3, true);
    }

    if (this.player._weapon.autofire) {
      this.player._weapon.fireAtPointer(game.input.activePointer);
      this.player._weapon2.fireAtPointer(game.input.activePointer);
